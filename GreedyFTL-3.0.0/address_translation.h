...
#define RESERVED_FREE_BLOCK_COUNT 0x1 // FIXME
 ...
 * // FIXME: what if very small `USER_BLOCKS_PER_LUN`
 */
 ...
 *
 * // FIXME: This may reduce the flash lifetime since this is not true SLC mode.
 * // FIXME: Why the LSB page is at odd page ??
 */
 ...
 *
 * FIXME: No need to check if `pageNo` > 0 or not.
 */
...
typedef struct _VIRTUAL_BLOCK_ENTRY
{
    ...
    unsigned int invalidSliceCnt : 16; // how many invalid slices in this block, //TODO: for GC?
